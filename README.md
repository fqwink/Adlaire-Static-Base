...
Rev.88 では、実行時データの初期化・自動生成・不足補完を禁止し、起動設定ファイルと `storage.basePath` 配下の実行時 JSON を分離しています。P0をP0-1〜P0-4へ分け、P0初回実装を最小Go骨格と `asb version` のみに限定しています。
