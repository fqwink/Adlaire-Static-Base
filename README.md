...
ASB Web UI は、ASB 本体外の内製管理画面クライアントとして扱い、静的 HTML / CSS / JavaScript とブラウザ標準 API のみで実装します。ASB Web UI は、Browser JavaScript SDK を利用して ASB 管理 HTTPS JSON API と通信します。
