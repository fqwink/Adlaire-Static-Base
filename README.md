...
Auteur は ASB に完全統合吸収し、`https://github.com/fqwink/Auteur` の仕様のみを ASB 仕様へ再分類して吸収します。Auteur の source code、runtime、CLI、fixture、CI、package、設定ファイル、生成物は移管せず、独立製品、独立サブシステム、外部依存、互換対象、migration 元として扱いません。
